#!/usr/bin/python3
"""
recursive func that queries the Reddit API and returns a list containing
the titles of all hot articles for a given subreddit. If no results are found
for the given subreddit, this function must return None.
"""
import requests
...
def recurse(subreddit, hot_list=[]):
    """
    obj is to return a list containing the titles of all hot articles
